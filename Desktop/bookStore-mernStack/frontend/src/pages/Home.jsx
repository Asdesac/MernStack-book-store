...
const Home = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("http://localhost:9000/books") // Ensure this endpoint is correct
      .then((response) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://localhost:9000/books/${id}`) // Ensure this endpoint is correct
      .then(() => {
            ...
            {books.map((book, index) => (
              <tr key={book._id} className="h-8">
                ...
                <td className="flex justify-center gap-x-4">
                  ...
                  <Link to="#" onClick={() => handleDelete(book._id)}>
